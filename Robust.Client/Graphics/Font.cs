...
namespace Robust.Client.Graphics
{
    ...
    public abstract class Font
    {
        ...
        /// <summary>
        ///     Draw a character stroke generated by the font backend.
        /// </summary>
        /// <param name="strokeStyle">Stoke style struct that stores information.</param>
        /// <returns>How much to advance the cursor to draw the next character.</returns>
        public virtual float DrawCharStroke(
        ...
        protected static int StrokeThicknessToFixed26Dot6(float strokeThickness)
        {
            ...
            var scaled = strokeThickness * 64f;
    ...
    public sealed class VectorFont : Font
    {
        ...
        public override float DrawCharStroke(
            DrawingHandleBase handle,
            Rune rune,
            Vector2 baseline,
            float scale,
            ...
            bool fallback = true)
        {
            ...
            var strokeStyleFixed = new FontStrokeStyleFixed(strokeThicknessFixed, strokeStyle.LineCap, strokeStyle.LineJoin);

            var metrics = Handle.GetCharMetrics(rune, scale, strokeStyleFixed);
            if (!metrics.HasValue)
            {
                if (fallback && !Rune.IsWhiteSpace(rune))
                {
                    rune = new Rune('�');
                    metrics = Handle.GetCharMetrics(rune, scale, strokeStyleFixed);
                    if (!metrics.HasValue)
                        return 0;
                }
                else
            ...
            var texture = Handle.GetCharTexture(rune, scale, strokeStyleFixed);
            if (texture == null)
                return metrics.Value.Advance;
    ...
    /// <summary>
    /// Line cap style for stroked glyph outlines.
    /// </summary>
    ...
    /// <summary>
    /// Line join style for stroked glyph outlines.
    /// </summary>
    ...
    /// <summary>
    /// Stroke style configuration used when drawing stroked glyphs.
    /// </summary>
    ...
    internal readonly record struct FontStrokeStyleFixed(
        int ThicknessFixed,
        FontStrokeLineCap LineCap = FontStrokeLineCap.Round,
        FontStrokeLineJoin LineJoin = FontStrokeLineJoin.Round);
